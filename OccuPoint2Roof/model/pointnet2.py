...
from .completion_net import FCABlock
...
class PointNet2(nn.Module):
    def __init__(self, model_cfg, in_channel=3):
        ...
        self.fca_block = FCABlock(channel=128)
    ...
    def forward(self, batch_dict):
        ...
        l0_fea_permuted = l0_fea.permute(0, 2, 1)
        l0_fea_refined = self.fca_block(l0_fea_permuted)
        l0_fea = l0_fea_refined.permute(0, 2, 1)
        ...
        batch_dict['point_features'] = l0_fea_refined
...
class PointNetFPModule(nn.Module):
    ...
    def forward(self, pts1, pts2, fea1, fea2):
        ...
        if fea1 is not None:
            new_features = torch.cat([interpolated_feats, fea1], dim=1)
        else:
